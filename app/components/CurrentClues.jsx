      ...
      if (!puzzle.grid[puzzle.activeCell[0]][puzzle.activeCell[1]].value) {
        ...
        try {
          ...
          for (let i = 0; i < accs.length; i++) {
            ...
            x < 0
              ? (letters.push(acrossLetter), (x = letters.length - 1))
              : null;
            aStyles[i] = colors[x];
    ...
    return (
      <div class="current-clues">
        <div id="across">
          <div class="inline">
            ...
            <input
              ...
              style={{
                width: measureMyInputText(acrossNumber + "clue") + "px"
              }}
          ...
          <div class="current">
            ...
            <a
              ...
              href={
                "http://onelook.com/?w=" +
                across.word.toUpperCase().replace("-", "?")
              }
            >
              <img
                style={{ width: "16px" }}
          ...
          <div class="suggestions">
            {acrossSuggestions.map((x, i) => (
              <div class="inline">
                <div
                  class={"suggestion " + getStyle(i, "across")}
                  onClick={e => fillWithSuggestion(e, x, "across")}
                  onMouseEnter={e => showCrosses(e, false)}
                  onMouseLeave={e => hideCrosses(e)}
                >
                  {x}
                </div>
                <a>
        ...
        <div id="down">
          ...
          <div class="suggestions">
            {downSuggestions.map((x, i) => (
              <div class="inline">
                <div
                  class={"suggestion " + getStyle(i, "down")}
