      ...
      <div class="current-clues">
        <div id="across">
          ...
          <div class="suggestions">{acrossSuggestions.map(
              (x, i) => <div class="inline"><div class={'suggestion' + getStyle(i, "across")} onClick={(e) => fillWithSuggestion(e, x, 'across')}>{x} <a target="_blank" href={'http://onelook.com/?w=' + x}><img style={{width: '12px'}} src="https://cdn.glitch.com/7a2e2b2d-f058-4f81-950d-8b81f72c14fc%2Fonelook.png?v=1611800262010"/></a></div></div>
            )}
          </div>
        </div>
        <div id="down">
          ...
          <div class="suggestions">{downSuggestions.map(
              (x, i) => <div class="inline"><div class={'suggestion' + getStyle(i, "down")} onClick={(e) => fillWithSuggestion(e, x, 'down')}>{x} <a target="_blank" href={'http://onelook.com/?w=' + x}><img style={{width: '12px'}} src="https://cdn.glitch.com/7a2e2b2d-f058-4f81-950d-8b81f72c14fc%2Fonelook.png?v=1611800262010"/></a></div></div>
            )}
          </div>
        </div>
      </div>
