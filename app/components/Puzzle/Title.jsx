      ...
      <div className="puzzle-info" id="puzzle-info">
        ...
        <input
          ...
          style={{
            width:
              (title.length
                ? measureMyInputText(title)
                : measureMyInputText("Untitled")) + "px",
          }}
          value={title}
          type="text"
          onChange={(e) => handleChange(e, setTitle, setTitleWidth)}
        />
        <span>by </span>
        <input
          id="author"
          ...
          style={{
            width:
              (author.length
                ? measureMyInputText(author)
                : measureMyInputText("Author")) + "px",
          }}
          value={author}
          type="text"
          onChange={(e) => handleChange(e, setAuthor, setAuthorWidth)}
        />
      </div>
    </div>
  );
